...
import com.example.client.ui.McefBrowserView;
...
public abstract class MossuraMcefHandledScreen<T extends ScreenHandler> extends HandledScreen<T> implements MossuraUiActionHandler, MossuraUiRefreshable {
	...
	protected MossuraMcefHandledScreen(T handler, PlayerInventory inventory, Text title, String route) {
	...
	protected void drawForeground(DrawContext context, int mouseX, int mouseY) {
		// Intentionally empty. Browser UI handles all rendering.
	}

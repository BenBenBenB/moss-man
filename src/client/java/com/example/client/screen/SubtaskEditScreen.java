...
public class SubtaskEditScreen extends Screen {
	...
	public SubtaskEditScreen(Screen parent, UUID projectId, UUID ticketId, Subtask subtask) {
		super(Text.literal("Edit Subtask"));
		this.parent = parent;
	...
	public void setInitialValues(String name, String description) {
		if (nameField != null) {
	...
	private void save() {
		...
		ClientPlayNetworking.send(new MossuraPayloads.UpdateSubtaskPayload(projectId, ticketId, subtaskId, name, descriptionField.getText()));
